 ...
 */
public class WeekBar extends android.support.v7.widget.AppCompatTextView {
    ...
    public WeekBar(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.getApplicationContext().obtainStyledAttributes(attrs, R.styleable.NCalendar);
