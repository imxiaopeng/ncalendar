...
import com.ncalendar.enumeration.CalendarState;
...
import com.ncalendar.listener.OnCalendarScrollingListener;
import com.ncalendar.listener.OnCalendarStateChangedListener;
import com.ncalendar.listener.OnClickDisableDateListener;
import com.ncalendar.listener.OnEndAnimatorListener;
...
import com.ncalendar.utils.ViewUtil;
...
public abstract class NCalendar extends FrameLayout implements IICalendar, NestedScrollingParent, ValueAnimator.AnimatorUpdateListener {
    ...
    public NCalendar(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NCalendar(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
